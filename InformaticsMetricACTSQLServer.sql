...
SELECT
  'total_encounters' AS VARIABLE_NAME,
   ...
   ( SELECT COUNT(DISTINCT OBS.ENCOUNTER_NUM) CNT
        FROM OBSERVATION_FACT OBS WHERE CONVERT(DATE,OBS.START_DATE) BETWEEN CAST('2020/01/01' AS DATE) AND CAST('2020/12/31' AS DATE)
    ) AS ONE_YEAR,
    
    ( SELECT COUNT(DISTINCT OBS.ENCOUNTER_NUM) CNT
        FROM OBSERVATION_FACT OBS WHERE CONVERT(DATE,OBS.START_DATE) BETWEEN CAST('01-01-2016' AS DATE) AND CAST('12-31-2020' AS DATE)
    ) AS FIVE_YEAR
;
...
SELECT
  'total_patients' AS VARIABLE_NAME,
   ...
   ( SELECT COUNT(DISTINCT OBS.PATIENT_NUM) CNT
        FROM OBSERVATION_FACT OBS WHERE CONVERT(DATE,OBS.START_DATE) BETWEEN CAST('01-01-2020' AS DATE) AND CAST('12-31-2020' AS DATE)
    ) AS ONE_YEAR,
...
SELECT
  'uniq_pt_with_gender' AS VARIABLE_NAME,
   ...
   ( SELECT COUNT(DISTINCT OBS.PATIENT_NUM) CNT
        ...
        WHERE CONVERT(DATE,OBS.START_DATE) BETWEEN CAST('01-01-2020' AS DATE) AND CAST('12-31-2020' AS DATE)
    ) AS ONE_YEAR,
    
    ( SELECT COUNT(DISTINCT OBS.PATIENT_NUM) CNT
        FROM OBSERVATION_FACT OBS
        JOIN PATIENT_DIMENSION PAT ON PAT.PATIENT_NUM = OBS.PATIENT_NUM AND (PAT.SEX_CD IS NULL OR PAT.SEX_CD <> 'DEM|SEX:NI')
        WHERE CONVERT(DATE,OBS.START_DATE) BETWEEN CAST('01-01-2016' AS DATE) AND CAST('12-31-2020' AS DATE)
    ) AS FIVE_YEAR
;
  ...
  'total_pt_gt_12' AS VARIABLE_NAME,
   ...
   ( SELECT COUNT(DISTINCT OBS.PATIENT_NUM) CNT
        ...
        JOIN PATIENT_DIMENSION PAT ON PAT.PATIENT_NUM = OBS.PATIENT_NUM 
            AND PAT.BIRTH_DATE IS NOT NULL AND DATEDIFF(YEAR, PAT.BIRTH_DATE, CONVERT(DATE,OBS.START_DATE)) > 12 
        WHERE CONVERT(DATE,OBS.START_DATE) BETWEEN CAST('01-01-2020' AS DATE) AND CAST('12-31-2020' AS DATE)
    ) AS ONE_YEAR,
...
SELECT
  'uniq_pt_snomed_proc' AS VARIABLE_NAME,
   ...
   ( SELECT COUNT(DISTINCT OBS.PATIENT_NUM) CNT
        ...
        JOIN OBSERVATION_FACT OBS ON OBS.CONCEPT_CD = MAP.CONCEPT_CD AND CONVERT(DATE,OBS.START_DATE) BETWEEN CAST('01-01-2020' AS DATE) AND CAST('12-31-2020' AS DATE)
    ) AS ONE_YEAR,
    
    ( SELECT COUNT(DISTINCT OBS.PATIENT_NUM) CNT
        FROM MAPPED_DOMAIN MAP
        JOIN OBSERVATION_FACT OBS ON OBS.CONCEPT_CD = MAP.CONCEPT_CD AND CONVERT(DATE,OBS.START_DATE) BETWEEN CAST('01-01-2016' AS DATE) AND CAST('12-31-2020' AS DATE)
    ) AS FIVE_YEAR
)
INSERT INTO #CTSA_CLIC_METRIC
